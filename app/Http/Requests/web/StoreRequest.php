...
//        return auth()->user()->check();
    ...
    public function rules()
    {
        return [
            ...
            'guild'                       => 'required|exists:guild,id' ,
            'store_name'                  => 'required|string' ,
            'username'                    => 'required|string|alpha_dash|unique:store,user_name' ,
//            'username'                    => ['required' , 'string' , new StoreRule()] ,
...
//            'payment_type'                => 'required|in:online,postal,both' ,
    ...
    public function messages()
    {
        return [
            ...
            'username.required'      => 'نام کاربری فروشگاه الزامی است.',
            'username.alpha_dash'      => 'نام کاربری باید الزاما کاراکترهای انگلیسی باشند.',
            'username.unique'        => 'این نام کاربری قبلا توسط فروشگاه دیگری انتخاب شده است.',
...
//            'payment_type.in'            => 'نحوه پرداخت نامعتبر است.',
            ...
            // 'thumbnail_photo.max'    => 'حجم عکس بندانگشتی حداکثر 512 کیلو بایت است.',
        ];
    }
