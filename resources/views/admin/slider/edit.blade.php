        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <form action="{{ route('updateSlider' , $sliderId->id) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="{{ $sliderId->alt }}"
                                                   name="alt" id="alt">
                                            @if($errors->has('alt'))
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="slider_type" id="slider_type" class="form-control">
                                                <option {{$sliderId->type == App\Slider::HOME ? 'selected' : ''}} value="{{App\Slider::HOME}}">صفحه اصلی</option>
                                                <option {{$sliderId->type == App\Slider::PRODUCT ? 'selected' : ''}} value="{{App\Slider::PRODUCT}}">صفحه محصولات</option>
                                                <option {{$sliderId->type == App\Slider::STORE ? 'selected' : ''}} value="{{App\Slider::STORE}}">صفحه فروشگاه ها</option>
                                                <option {{$sliderId->type == App\Slider::SERVICE ? 'selected' : ''}} value="{{App\Slider::SERVICE}}">صفحه خدمات</option>
                                            </select>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="link_to" id="link_to" class="form-control">
                                                ...
                                                <option {{ $sliderId->product_id ? 'selected' : '' }} value="product">محصول</option>
                                                <option {{ $sliderId->store_id ? 'selected' : '' }} value="store">فروشگاه</option>
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <a href="{{ \Illuminate\Support\Facades\URL::previous() }}"
                                               class="btn btn-sm btn-pinterest">انصراف</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
