        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title"><b>افزودن صنف محصولات</b></h4><br>
                            @if($errors->any())
                            ...
                            <form role="form" action="{{ route('createGuild') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <button name="guild_type" value="product" type="submit" style="margin-top: 25px;"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 class="m-t-0 header-title"><b>لیست اصناف محصولات</b></h4>
