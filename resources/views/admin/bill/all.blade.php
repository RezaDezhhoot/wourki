                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="province_buyer" id="province_buyer" class="js-example-basic-single">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="pay_type" id="pay_type" class="js-example-basic-single">
                                                <option value="all" disabled selected>::انتخاب کنید::</option>
                                                <option {{ request()->input('pay_type') == 'online' ? 'selected' : '' }} value="online">آنلاین</option>
                                                <option {{ request()->input('pay_type') == 'postal' ? 'selected' : '' }} value="postal">پستی</option>
                                                <option {{ request()->input('pay_type') == 'both' ? 'selected' : '' }} value="both">هردو</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="province_seller" id="province_seller" class="js-example-basic-single">
                                                <option value="all" disabled selected>::انتخاب کنید::</option>
                                                @foreach($provinces as $province)
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="js-example-basic-single">
                                                ...
                                                <option {{ request()->input('status') == 'delivered' ? 'selected' : '' }} value="delivered">تحویل داده شده</option>
                                                ...
                                                <option {{ request()->input('status') == 'paid_back' ? 'selected' : '' }} value="paid_back">بازگشت مبلغ</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ request()->input('price_from') }}" name="price_from" id="price_from" class="form-control input-sm" placeholder="قیمت ابتدایی را وارد کنید...">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="price_to">قیمت تا</label>
                                            <input type="number" value="{{ request()->input('price_to') }}" name="price_to" id="price_to" class="form-control input-sm" placeholder="قیمت پایانی را وارد کنید...">
                                        </div>
                                    </div>
                                </div>
                                <br>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 class="m-t-0 header-title"><b>لیست اسناد فروشگاه ها</b></h4>
                                            ...
                                            <form action="{{ route('submitDocumentOfBill') }}" method="post">
                                                ...
                                                <table class="table table-striped m-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>تاریخ و ساعت</th>
                                                        <th>
                                                            <span style="font-size: 20px;margin-right: 20%;" class="glyphicon glyphicon-eye-open"></span>
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                    <?php $id = 1; ?>
                                                    ...
                                                    @foreach($billsInfo as $bill)
                                                        <tr>
                                                            <th><input type="checkbox" name="billId[]" class="bill-item" value="{{ $bill->id }}"></th>
                                                            <th>{{ $bill->id }}</th>
                                                                ...
                                                                <div class="btn-group m-b-20">
                                                                    <div class="btn-group">
                                                                        @if($bill->status == 'delivered')
                                                                            <a class="btn btn-xs btn-success">تحویل داده شده</a>
