                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="js-example-basic-single">
                                                ...
                                                <option {{ request()->input('status') == 'paid_back' ? 'selected' : '' }} value="paid_back">
                                                    بازگشت مبلغ
                                                </option>
                                            </select>
                                        </div>
                                            ...
                                            <form action="{{ route('bills.adminConfirmBill') }}" method="post">
                                                ...
                                                <table class="table table-striped m-0">
                                                    ...
                                                    @foreach($billsInfo as $bill)
                                                        <tr>
                                                            <th><input type="checkbox" name="billId[]" class="bill-item"
                                                                       value="{{ $bill->id }}"></th>
                                                            <th>{{ $bill->id }}</th>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        @if($bill->status == 'delivered')
                                                                            <a class="btn btn-xs btn-success">تحویل داده
                                                                                شده</a>
                                                                        @elseif($bill->status == 'rejected' || $bill->status == 'rejected')
                                                ...
                                                {{ $billsInfo->appends(request()->query())->links() }}
                                                <br>
                                                @if(request()->get('confirmed') == 0)
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <button type="submit"
                                                                    class="btn input-sm btn-purple waves-effect waves-light"
                                                                    name="type" value="confirm">تایید سفارش
                                                            </button>
                                                        </div>
                                                    </div>
                                                @endif
