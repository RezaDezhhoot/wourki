                    ...
                    <div class="col-sm-12">
                        <form action="{{ url()->current() }}" method="get">
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label for="product_name" class="control-label">انتخاب محصول</label>
                                        <input type="text" name="keyword" id="product_name" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <button type="submit" name="filter" class="btn btn-info waves-effect waves-light">اعمال فیلتر</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                                            ...
                                            <table class="table m-0">
                                                ...
                                                @foreach($products as $product)
                                                    <tr>
                                                        ...
                                                        <td>{{ $product->name }}</td>
                                                        <<td>
                                                            <textarea style="text-align: right;" class="form-control" cols="70" rows="10">
                                                                {{ $product->description }}
                                                            </textarea>
                                                        </td>
    ...
    <script>
        function addProduct(element) {
            element.select2({
                ...
                ajax: {
                    url: '{{ route('searchNamesOfProducts') }}',
                    dataType: 'json',
                    delay: 250,
                    params: {
