                                ...
                                <article class="row">
                                    <div class="col-md-2 col-sm-2 hidden-xs">
                                        <figure class="thumbnail">
                                            ...
                                            <figcaption class="text-center">{{ $comment->user_first_name }}&nbsp;{{ $comment->user_last_name }}</figcaption>
                                        </figure>
                                    </div>
                                ...
                                @foreach($childComments as $parentComment)
                                    <article class="row">
                                        <div class="col-md-2 col-sm-2 hidden-xs">
                                            <figure class="thumbnail">
                                                <img class="img-responsive" src="{{ URL::to('/admin') }}/assets/images/doc_placeholder.png">
                                                <figcaption class="text-center">{{ $parentComment->user_first_name }}
                                                    &nbsp;{{ $parentComment->user_last_name }}</figcaption>
                                            </figure>
                                        </div>
                                        <div class="col-md-10 col-sm-10">
                                            <div class="panel panel-default arrow left">
                                                ...
                                                <div class="panel-body">
                                                    <header class="text-left">
                                                        <div class="comment-user"><i class="fa fa-user"></i> ارسال شده توسط {{ $parentComment->user_first_name }}
                                                        </div>
                                                        <time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o"></i>ارسال شده در تاریخ {{ jDate($parentComment->created_at)->format('%B %d، %Y') }}
                                                        </time>
                                                    </header>
                                                    <br>
                                                    <div class="comment-post">
                                                    ...
                                                    <p class="text-right">
                                                        <a href="{{ route('approvedComment' , $parentComment->id) }}" class="btn btn-success btn-sm">تایید
                                                            @php
                                                            if ($parentComment->status == 'approved')
                                                            echo '<i class="ti-check"></i>';
                                                            @endphp
                                                        </a>
                                                        <a href="{{ route('rejectComment' , $parentComment->id) }}" class="btn btn-warning btn-sm">رد کردن
                                                            @php
                                                        ...
                                                        <a href="{{ route('deleteComment' , $parentComment->id) }}" class="btn btn-danger btn-sm">حذف
                                                            @php
                                                        ...
                                                        <a href="{{ route('pendingComment' , $parentComment->id) }}" class="btn btn-default btn-sm"> معلق
                                                            @php
