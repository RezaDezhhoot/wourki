...
@section('style')
    <title>وورکی | حساب کاربری من | ثبت فروشگاه بازاریابی</title>
@endsection
@section('content')
                ...
                <div class="row">
                    <form action="{{ route('stores.store') }}" method="post" class="form-horizontal"
                        ...
                        <div class="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2">
                            @if(!$hasSubscription)
                                <div class="alert alert-warning text-center">کاربر گرامی، برای ثبت فروشگاه بازاریابی ابتدا باید
                                    پلن اشتراک بازاریابی تهیه کنید.
                                </div>
                            @elseif(!$hasAddress)
                                <div class="alert alert-warning text-center">
                                    کاربر گرامی برای ثبت فروشگاه بازاریابی ابتدا باید حداقل یک آدرس ثبت کنید.
                                </div>
                            @else
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 text-center submit-btn-wrapper">
                                                <button name="store_type" value="market" type="submit" class="btn btn-pink btn-sm btn-bordered">ثبت
                                                    فروشگاه
                                                </button>
                                            </div>
                                        </div>
