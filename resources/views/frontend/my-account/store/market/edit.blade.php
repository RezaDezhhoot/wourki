                                ...
                                <div class="panel-body buy-plan-panel">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            ...
                                            @else
                                                <h4 class="text-center">
                                                    کاربر گرامی، شما فروشگاه خود را ثبت کرده اید، اما برای فعالیت بازاریابی نیاز به خرید پلن بازاریابی دارید
                                                </h4>
                                                <a href="{{ route('user.plan.create.page') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 text-center">
                                                <a href="{{ route('market.products') }}"
                                                   class="btn btn-xs btn-pink">آیتم های فروشگاه بازاریابی</a>
                                        </div>
                                        <div class="col-xs-6 text-center">
                                                <a href="{{ route('market.bill-items') }}"
                                                   class="btn btn-xs btn-pink">فاکتور های فروش بازاریابی</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 text-center submit-btn-wrapper">
                                            <button name="store_type" value="market" type="submit" class="btn btn-pink btn-sm btn-bordered">
