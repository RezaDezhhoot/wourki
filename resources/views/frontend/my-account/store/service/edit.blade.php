                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 text-center submit-btn-wrapper">
                                            <button name="store_type" value="service" type="submit" class="btn btn-pink btn-sm btn-bordered">
                                                @if($store)ویرایش فروشگاه خدماتی
                                                @else ثبت فروشگاه خدماتی
                                                @endif
                                            </button>
                                        </div>
                                    </div>
